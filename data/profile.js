...
const PROFILE = {
  ...
  about: {
    id: `Saya memiliki perjalanan karir yang unik. Latar belakang saya di teknik otomotif melatih saya untuk berpikir secara sistematis dalam melakukan troubleshooting, sebuah kemampuan yang ternyata sangat krusial saat melakukan debugging dalam penulisan kode. Selain itu, pengalaman di bidang Affiliate Marketing mengajarkan saya tentang analisis data dan perilaku pengguna.\n\nSaat ini, saya mendalami Web Development, UI/UX, dan Desain Komunikasi Visual. Saya tidak hanya menulis kode, tapi fokus memecahkan masalah (problem-solving). Kombinasi antara logika sistematis mesin, pemahaman data dari marketing, dan eksekusi visual-teknis membuat saya mampu melihat sebuah proyek secara utuh, baik dari sisi kode, estetika, maupun bisnis.`,
  ...
  highlights: [
    {
      ...
      desc: { id: "Belajar konsisten tiap hari, mulai dari dokumentasi resmi, video tutorial, hingga proyek latihan mandiri yang nyata.", en: "Learning consistently every day, starting from official docs and video tutorials to real independent practice projects." },
    ...
    },
    {
      ...
      desc: { id: "Membangun aplikasi web end-to-end, mulai dari antarmuka React di sisi frontend hingga REST API Node.js/FastAPI dan manajemen database PostgreSQL/Supabase di sisi backend.", en: "Building end-to-end web applications, starting from React interfaces on the frontend to Node.js/FastAPI REST APIs and PostgreSQL/Supabase database management on the backend." },
    ...
    },
    {
      ...
      desc: { id: "Merancang antarmuka dan aset visual grafis yang bersih dan intuitif menggunakan Figma dan Canva, mulai dari wireframe, prototype interaktif, hingga materi komunikasi visual.", en: "Designing clean, intuitive interfaces and visual graphic assets using Figma and Canva, starting from wireframes and interactive prototypes to visual communication materials." },
    ...
    },
    {
      ...
      desc: { id: "Mahir menggunakan Microsoft Office (Word, Excel, PowerPoint) & Google Workspace yang diasah intensif lewat tugas akademik dan pelaporan data profesional.", en: "Proficient in using Microsoft Office (Word, Excel, PowerPoint) & Google Workspace, intensively honed through academic assignments and professional data reporting." },
  ...
  training: [
    ...
    },
    {
      ...
      organizer: "Codelamp Indonesia",
      period: "2026",
      desc: { id: "Pelatihan penerapan AI dalam proses rekayasa perangkat lunak. Mencakup penggunaan AI tools untuk mendukung siklus pengembangan software, mulai dari perencanaan, penulisan kode, debugging, hingga dokumentasi yang lebih efisien.", en: "Training on the application of AI in the software engineering process. Covers the use of AI tools to support the software development lifecycle, starting from planning, coding, and debugging to more efficient documentation." },
