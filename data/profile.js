...
const PROJECTS = [
  ...
  },
  {
    ...
    desc: "Desain antarmuka aplikasi mobile (Food Delivery) yang dirancang khusus untuk memudahkan pemesanan menu Warmindo secara online. Fokus pada tata letak yang bersih, navigasi kategori makanan yang cepat, serta pengalaman pengguna yang intuitif agar proses pemesanan menjadi lebih praktis.",
  ...
  },
  {
    ...
    category: "ui",
    tags: ["Figma", "UI/UX", "Prototyping"],
    desc: "Rancangan dasbor web (B2B) untuk manajemen sistem pergudangan yang komprehensif. Desain ini mencakup modul pemantauan stok (Storage Bin), pendataan aset, hingga pengelolaan pemasok (Supplier). Antarmuka difokuskan pada penyajian ringkasan data yang padat namun tetap bersih dan mudah dibaca oleh operator.",
    features: ["Interactive Prototype", "Design System", "Auto Layout", "Mobile-First", "WebApp"],
    demo: "", 
