...
window.I18N = {
  ...
  dict: {
    ...
    abt_val1_title: { id: "Terus Belajar", en: "Continuous Learning" },
    abt_val1_desc: { id: "Dunia teknologi berkembang cepat — saya berkomitmen untuk selalu update skill dan pengetahuan tanpa henti.", en: "The tech world evolves rapidly — I am committed to continuously updating my skills and knowledge." },
    abt_val2_title: { id: "Kerja Tim", en: "Teamwork" },
    abt_val2_desc: { id: "Pernah memimpin organisasi, saya memahami pentingnya kolaborasi, empati, dan komunikasi efektif.", en: "Having led organizations, I understand the importance of collaboration, empathy, and effective communication." },
    abt_val3_title: { id: "Adaptif", en: "Adaptive" },
    abt_val3_desc: { id: "Dari bengkel mesin ke kode program — saya terbiasa masuk ke lingkungan baru dan cepat menyesuaikan diri.", en: "From a machine workshop to code programming — I am used to entering new environments and adapting quickly." },
    abt_val4_title: { id: "Sistematis & Terstruktur", en: "Systematic & Structured" },
    abt_val4_desc: { id: "Berbekal kecakapan administratif dan manajerial, saya memastikan setiap kode, dokumentasi, dan pelaporan data terkelola secara rapi dan profesional.", en: "Equipped with administrative and managerial skills, I ensure every code, documentation, and data reporting is managed neatly and professionally." },
    abt_val5_title: { id: "Problem Solver", en: "Problem Solver" },
    abt_val5_desc: { id: "Berorientasi pada solusi. Saya melihat error sebagai tantangan menarik, bukan hambatan yang menghentikan.", en: "Solution-oriented. I view errors as interesting challenges, not stopping hurdles." },
    abt_val6_title: { id: "Pemikiran Analitis", en: "Analytical Thinking" },
    abt_val6_desc: { id: "Membongkar masalah sistem kompleks menjadi bagian kecil yang dapat dikelola, dan dieksekusi secara terstruktur.", en: "Breaking down complex system problems into manageable small parts, and executing them in a structured manner." },
    abt_val7_title: { id: "Integrasi Efisien (AI)", en: "Efficient Integration (AI)" },
    abt_val7_desc: { id: "Memanfaatkan kapabilitas AI (Kecerdasan Buatan) secara komprehensif ke dalam alur kerja untuk memangkas waktu riset dan mengoptimalkan penulisan kode.", en: "Utilizing AI (Artificial Intelligence) capabilities comprehensively in the workflow to cut research time and optimize code writing." },
    abt_val8_title: { id: "Fokus Pengguna (UI/UX)", en: "User Focus (UI/UX)" },
    abt_val8_desc: { id: "Tidak sekadar berfungsi. Saya memastikan setiap antarmuka yang dibangun intuitif, responsif, dan memberikan pengalaman visual yang memanjakan mata.", en: "Not just functional. I ensure every interface built is intuitive, responsive, and provides a visually pleasing experience." },
    abt_val9_title: { id: "Administrasi Office", en: "Office Administration" },
    abt_val9_desc: { id: "Terampil mengoperasikan Microsoft Office (Word, Excel, PowerPoint) untuk menyusun dokumentasi, pelaporan, dan pengelolaan data administratif secara efisien.", en: "Skilled in operating Microsoft Office (Word, Excel, PowerPoint) to prepare documentation, reporting, and efficiently manage administrative data." },
    ...
    res_core_competencies: { id: "Kompetensi Inti & Profesionalisme", en: "Core Competencies & Professionalism" },
    res_core_comp_desc: { id: "Implementasi keahlian teknis dan organisasional dari pengalaman nyata di lapangan.", en: "Implementation of technical and organizational skills from real-world field experience." },
